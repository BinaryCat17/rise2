...
namespace rise {
    ...
    void updateCamera(entt::registry &r, entt::entity camera, Instance &instance,
            scenePipeline::Global *data) {
    ...
    void updatePointLight(entt::registry &r, Instance &instance, scenePipeline::Global *data) {
        auto entities = r.view<PointLight>();
