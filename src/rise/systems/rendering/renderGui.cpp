...
namespace rise {
    ...
    using GuiState = std::shared_ptr<GuiStateT>;
    ...
    void initGui(flecs::world &ecs, LLGL::RenderSystem *renderer, SDL_Window *window,
        ...
        auto state = std::make_shared<GuiStateT>();
        ecs.set<GuiState>(state);
    ...
    void renderGui(flecs::world &ecs, LLGL::RenderSystem *renderer,
        ...
        auto state = checkGet<GuiState>(ecs);
